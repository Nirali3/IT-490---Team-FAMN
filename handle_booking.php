...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO Bookings (airline, departureAirport, arrivalAirport, departureDate, arrivalDate, total_price) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->execute([$airline, $departureAirport, $arrivalAirport, $departureDate, $arrivalDate, $total_price]);
